        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+33427542977" className="hover:text-white transition-colors" data-testid="footer-phone-link">04 27 54 29 77</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#tarifs" className="text-slate-400 hover:text-white transition-colors">Tarifs</a></li>
